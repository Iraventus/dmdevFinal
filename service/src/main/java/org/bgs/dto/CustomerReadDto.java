...
public class CustomerReadDto extends UserReadDto {
    ...
    public CustomerReadDto(Long id, String login, String password, String firstname, String lastname, String phone, Role role, LocalDate birthDate, AddressNode address) {
